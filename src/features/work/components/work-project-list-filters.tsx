...
export const SERVICE_SORT_OPTIONS = [
  ...
  { label: "WorkProject Name: A to Z", value: "name|asc" },
  { label: "WorkProject Name: Z to A", value: "name|desc" },
  { label: "Created: Newest First", value: "published_at|desc" },
  { label: "Created: Oldest First", value: "published_at|asc" },
];

type WorkProjectListFiltersProps = {
...
export function WorkProjectListFilters({
  query,
  onSearchChange,
  onStatusChange,
  onSortChange,
}: WorkProjectListFiltersProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mb-6">
      <div className="flex-1 max-w-sm">
        <Input
          placeholder="Search for workProjects..."
          value={localSearch}
