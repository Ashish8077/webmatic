    ...
    <section id="company-overview" className="relative bg-white py-16 overflow-hidden">
      <div className="relative z-10 mx-auto max-w-292.5 px-5 sm:px-8">
        ...
        <ScrollReveal delay={0.2}>
          <div className="max-w-190 mx-auto bg-white rounded-xl p-8 border border-slate-100 shadow-sm relative transition-all duration-200 hover:shadow-md">
              ...
              <div className="text-center text-[13px] text-slate-500 mt-5">
                ...
                {data.bottomText.linkText && data.bottomText.linkUrl && (
                  <Link
                    ...
                    className="inline-flex items-center font-semibold text-hero-primary hover:text-hero-primary-hover transition-colors duration-200 underline-offset-4 hover:underline"
                  >
